...
weekDay = currentDate1.getDay();
// Step 4: Declare a variable to hold a message that will be displayed
let message;
// Step 5: Using an if statement, if the day of the week is a weekday (i.e. Monday - Friday), set the message variable to the string 'Hang in there!'
if(weekDay>6){
    message = "Hang it there!";
...
switch(weekDay){
    case 1:message2="Monday";console.log(message2);
    break;
    case 2:message2="Tuesday";console.log(message2);
    break;
    case 3:message2="Wednesday";console.log(message2);
    break;
    case 4:message2="Thursday";console.log(message2);
    break;
    case 5:message2="Friday";console.log(message2);
    break;
    case 6:message2="Saturday";console.log(message2);
    break;
    case 7:message2="Sunday";console.log(message2);
    break;
}
/* OUTPUT */
